...
<!-- heige-package-sha256 --> Package SHA-256: 27f4334064abed23fcd8c65cde408ae97437515800437696abd565b96ce7536f
...
- 本分支完成后，建议用经过验证的新版本正常取代旧 Latest Release，而不是静默覆盖旧资产。本轮审计不发布或编辑 Release。
...
2. 通过正常新版本 Release 取代旧 Latest Release，并保留旧资产的可追溯性。
